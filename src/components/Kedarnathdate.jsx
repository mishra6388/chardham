...
import kedarnathbg from "../assets/kedarnathbg.png";

const KedarnathContainer = () => {
    return (
        <div className="flex items-center bg-gray-100 p-4 rounded-lg shadow-md w-full max-w-screen-md mx-auto gap-2">
            {/* Image Section */}
            <div className="w-40 h-40 flex-shrink-0">
                <img src={kedarnathbg} alt="Kedarnath" className="w-full h-full object-cover rounded-lg" />
            </div>

            {/* Text Section (Moved Up by 5px using -mt-1) */}
            <div className="text-left -mt-1">
                <h3 className="text-xl font-semibold mb-1">Kedarnath Opening Date</h3>
...
export default KedarnathContainer;
